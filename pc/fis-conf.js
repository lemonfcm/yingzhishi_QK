<!--param start-->
    //修改cdn的绝对路径（测试环境）
    fis.set('cdn-path','http://test.nie.163.com/test_cdn/god/m/zt/20161215191826');
    //修改cdn的绝对路径（正式环境）
    fis.set('cdn-path-release','https://god.res.netease.com/m/zt/20161215191826');
    //修改雪碧图放大缩小倍数，默认是1，iphone是0.5
    fis.set('css-scale',1);
    //修改include文件的域名
    fis.set('include-host','http://god.163.com')
<!--end-->
